package com.orangehrm.tests.driver;
...
public enum DriverType {
    ...
    CHROME {
        ...
        WebDriver createDriver() {
            ...
            setDriverPropertyIfUnset("webdriver.chrome.driver", driverDir + "chromedriverMAC" + (isWin ? ".exe" : ""));
    ...
    private static final String driverDir = "src/test/java/com/orangehrm/tests/utils/drivers/";
